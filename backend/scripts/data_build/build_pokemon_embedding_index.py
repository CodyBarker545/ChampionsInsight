"""Builds the Pok̩mon embedding index used by opponent detection."""
...
def build_pokemon_embedding_index():
    ...
    print(f"Loaded {len(references)} Pok̩mon reference images.")
    ...
    if not embeddings:
        raise RuntimeError("No Pok̩mon embeddings were created.")
    ...
    print("Pok̩mon embedding index built.")
